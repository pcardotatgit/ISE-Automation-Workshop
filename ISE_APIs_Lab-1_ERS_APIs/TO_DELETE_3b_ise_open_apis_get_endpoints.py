...
def main():
    ...
    route="/main"
    env.level+="-"
    print("\n"+env.level,white("def main() in 3b_ise_open_apis_get_endpoints.py : >\n",bold=True))
    loguer(env.level+" def main() in 3b_ise_open_apis_get_endpoints.py : >")
    global username
    global password
    global host
    global port
...
def parse_config_to_dict(config_json_file):
    ...
    '''
    env.level+='-'
    print(env.level,white('def parse_config_to_dict() in 3b_ise_open_apis_get_endpoints.py  : >\n',bold=True))
    loguer(env.level+' def parse_config_to_dict() in 3b_ise_open_apis_get_endpoints.py : > ')
...
def send_api_call_function(username,password,method,api_url,headers,payload,result_file_name):
    ...
    '''
    print()
    print(white('def send_api_call_function() in 3b_ise_open_apis_get_endpoints.py  : >\n',bold=True))
    # ===================================================================                                            
